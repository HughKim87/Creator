...
ARTIFACT_OWNERS: dict[str, str] = {
    "schemas/common-record-v1.schema.json": "docs/FILE_DATA_CONTRACT.md",
    "schemas/work-request-payload-v1.schema.json": "docs/WORK_STATE_CONTRACT.md",
    "schemas/work-event-payload-v1.schema.json": "docs/WORK_STATE_CONTRACT.md",
    "schemas/work-state-payload-v1.schema.json": "docs/WORK_STATE_CONTRACT.md",
    "schemas/source-payload-v1.schema.json": "docs/KNOWLEDGE_TYPES_CONTRACT.md",
    "schemas/knowledge-payload-v1.schema.json": "docs/KNOWLEDGE_TYPES_CONTRACT.md",
    "schemas/decision-payload-v1.schema.json": "docs/KNOWLEDGE_TYPES_CONTRACT.md",
    "schemas/failure-knowledge-payload-v1.schema.json": "docs/KNOWLEDGE_TYPES_CONTRACT.md",
    "schemas/lifecycle-event-payload-v1.schema.json": "docs/KNOWLEDGE_LIFECYCLE_CONTRACT.md",
    "schemas/lifecycle-state-payload-v1.schema.json": "docs/KNOWLEDGE_LIFECYCLE_CONTRACT.md",
    "schemas/context-package-v1.schema.json": "docs/CONTEXT_PACKAGE_CONTRACT.md",
    "schemas/youtube-evidence-request-v1.schema.json": (
        "docs/domain/youtube/YOUTUBE_EVIDENCE_PACK_CONTRACT.md"
    ),
    "schemas/youtube-evidence-pack-v1.schema.json": (
        "docs/domain/youtube/YOUTUBE_EVIDENCE_PACK_CONTRACT.md"
    ),
    ...
    "tests/fixtures/file_data/invalid/missing-field.json": "docs/FILE_DATA_CONTRACT.md",
    "tests/fixtures/file_data/invalid/tampered-content.json": "docs/FILE_DATA_CONTRACT.md",
    "tests/fixtures/file_data/invalid/wrong-id.json": "docs/FILE_DATA_CONTRACT.md",
    "tests/fixtures/file_data/invalid/wrong-version.json": "docs/FILE_DATA_CONTRACT.md",
}
