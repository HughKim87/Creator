...
- Before continuing, run `tools/project_preflight.bat`; it validates Python, Git, existing scan roots, and includes `projectctl context`. Before file edits, claim the task with `start`.
