...
| [R-4 retrieval evaluation result](../reports/2026-07-21_R-4_검색_평가_결과.md) | Report | R-4 fixed-query metrics and conditional FTS decision evidence; no policy authority | `retained-evidence`; exact R-4 audit route | Auditing measured retrieval or establishing the R-5 operational baseline |
| [R-5 operational acceptance and final completion result](../reports/2026-07-21_R-5_운영_인수_및_전체_완료_결과.md) | Report | R-5 scenarios 1-9 and R-3-to-R-5 final completion evidence; no policy authority | `retained-evidence`; exact final audit route | Auditing operational acceptance, residual risks, or the final completion claim |
| [R0-to-R-5 scored re-audit](../reports/codex_2026-07-21_R0-R5_재검토_점수_분석.md) | Report | Evidence-based stage scores, deductions, cross-stage risks, and corrected completion boundary; no policy authority | `retained-evidence`; exact program-audit route | Auditing R0-to-R-5 quality or reconnecting the pre-R L0-to-L8 roadmap |
| [R0-to-R-5 independent cross-verification](../reports/claude_2026-07-21_R0-R5_독립_교차검증_보고.md) | Report | Independent second-pass verification of the scored re-audit, with re-measured figures and additional structural defects; no policy authority | `retained-evidence`; exact program-audit route | Confirming or challenging the scored re-audit, or prioritizing residual operational risk |
| [R0-to-R-5 score reconciliation](../reports/claude_2026-07-21_R0-R5_점수_교차검증.md) | Report | Adjudicated differences between the two scored analyses, source integrity records, and the reconciled 86.8 score; no policy authority | `retained-evidence`; exact program-audit route | Deciding the final R-stage score or checking which analysis prevailed on a disputed item |
| [Pre-L operational hardening result](../reports/codex_2026-07-22_L작업_전_운영_하드닝_개선_결과.md) | Report | Evidence for the three-iteration F-1-through-F-4 hardening, failures, measured projection reduction, concurrency proof, and remaining L boundary; no policy authority | `retained-evidence`; exact pre-L hardening audit route | Verifying runtime and context-system readiness before reconstructing the L0-to-L8 resume gate |
| [Codex Commands 1-to-4 fulfillment reanalysis](../reports/codex_2026-07-22_프로젝트_구조_분석_및_다음_작업_제안.md) | Report | Requirement-by-requirement audit of the final goal, common principles, Commands 1 through 4, corpus coverage, approval sequence, and the bounded next gap-analysis gate; no policy authority | `retained-evidence`; exact Commands 1-to-4 audit route | Auditing whether the original project-rebuild and knowledge-system requirements were fully met or selecting the next approved coverage step |
...
| [Python runtime PATH resolution case](../../knowledge/cases/case.project.python-runtime-path-resolution.md) | Case record | Active resolved evidence for Python launch failures caused by an unavailable PATH command; prevention authority stays in validation rules and workflow | `maintained-current`; task-routed, not startup | A Python command is unavailable, a runtime path changes, or the launcher regression fails |
