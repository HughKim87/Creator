...
- 오래된 리서치, 중간 산출물, 캐시, 버전별 XML은 현재 작업 경로에 두지 않고 `temp/archive/YYYY-MM-DD/`에 원래 경로 구조로 보관한다.
- `temp/archive/`, `temp/backups/`, 구 `workspace/outputs/` 산출물은 `문서_인덱스.md`에서 명시한 경우에만 읽는다.
